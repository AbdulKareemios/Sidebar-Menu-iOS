...
#import "GeographicViewController.h"
#import <MapKit/MapKit.h>
@interface GeographicViewController ()<MKMapViewDelegate>
{
    SingletonClass *objsingle;
}
@property (nonatomic,strong)IBOutlet MKMapView *geomapview;
@end

@implementation GeographicViewController
